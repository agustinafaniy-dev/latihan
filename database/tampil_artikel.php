...
<body class="bg-gray-100 p-6">
    <div class="max-w-6xl mx-auto bg-white rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="index.php?page=tambah_artikel" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded inline-flex items-center">
        ...
        $query = "SELECT artikel.id, artikel.judul, artikel.isi, artikel.gambar, kategori.nama_kategori FROM artikel JOIN kategori ON artikel.kategori_id = kategori.id";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<th class='px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider'>Kategori</th>";
            echo "<th class='px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider'>Gambar</th>";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td class='px-6 py-4 whitespace-nowrap text-sm text-gray-900'>" . $row['judul'] . "</td>";
                ...
                if (!empty($row['gambar'])) {
                    echo "<img src='" . $row['gambar'] . "' alt='Gambar' class='w-16 h-auto'>";
                } else {
                    echo "Tidak ada";
                }
                echo "</td>";
                echo "<td class='px-6 py-4 whitespace-nowrap text-sm font-medium'>";
                echo "<a href='index.php?page=edit_artikel&id=" . $row['id'] . "' class='text-indigo-600 hover:text-indigo-900 mr-3 inline-flex items-center'>";
                ...
                echo "Edit";
                echo "</a>";
                echo "<a href='hapus_artikel.php?id=" . $row['id'] . "' class='text-red-600 hover:text-red-900 inline-flex items-center' onclick='return confirm(\"Apakah Anda yakin ingin menghapus?\")'>";
                echo "<svg class='w-4 h-4 mr-1' fill='none' stroke='currentColor' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>";
            ...
            echo "<p class='text-gray-500 text-center py-8'>Tidak ada artikel ditemukan.</p>";
        }
